...
- lib directory - holds the source code for the Flutter project.
    ...
    - screens/list_screen.dart - the Main Screen - builds a scaffold (the basic structure of the screen, i.e. app bar, body, floating action button) which places the list of posts, provides the new post button, and handles the dialog for saving an image for the post.
